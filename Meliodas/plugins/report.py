...
from Meliodas.mongo.reportdb import Reporting
...
Meliodas will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. Meliodas assumes that admins 
