...
from Meliodas.mongo.notesdb import Notes, NotesSettings
from Meliodas.utils.cmd_senders import send_cmd
from Meliodas.utils.custom_filters import admin_filter, command, owner_filter
from Meliodas.utils.kbhelpers import rkb as ikb
from Meliodas.utils.msg_types import Types, get_note_type
from Meliodas.utils.string import (
    build_keyboard,
    escape_mentions_using_curly_brackets,
    parse_button,
)
from Meliodas.mongo.connectiondb import active_connection
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/MeliodasRobot?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
        ...
        pm_kb = ikb(
            [
                [
                    (
                        "All Notes",
                        f"https://t.me/MeliodasRobot?start=notes_{grp_id}",
                        "url",
                    ),
                ],
            ],
