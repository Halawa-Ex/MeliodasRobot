...
from Meliodas.utils.custom_filters import *
from pyrogram import filters
from pyrogram.types import Message
from Meliodas.utils.caching import ADMIN_CACHE, TEMP_ADMIN_CACHE_BLOCK, admin_cache_reload
from Meliodas.utils.parser import mention_html
from asyncio import sleep
from time import time
import os
from pyrogram import filters
from pyrogram.types import Message
from Meliodas.plugins.rules import *
from Meliodas import BOT_ID, app
from Meliodas.utils.functions import extract_user
...
async def adminlist_show(_, m: Message):
    ...
    try:
        ...
        if str(ef) == str(m.chat.id):
            ...
            await m.reply_text("error : @Knoxzx : `adminlist`")
    return
...
Sometimes, you promote or demote an admin manually, and Meliodas doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
...
that'll force Meliodas to check who the admins are again. 
"""
