...
from Meliodas.mongo import taggeddb
from button import *
...
async def mentioned_alert(client, message):   
    try:
        ...
        if "@" in input_str:
            ...
            Meliodas = input_str.split("|")[1]
            text = Meliodas.split()[0]
...
If you are tagged/mentioned in a group where Meliodas is present
Meliodas will notify it to you via private message after enabling tag alerts
...
**Example:**
If you are mentioned in a group Meliodas will tell you who mentioned you, 
